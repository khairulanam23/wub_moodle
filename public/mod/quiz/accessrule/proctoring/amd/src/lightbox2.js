                    ...
                    if(urlsplit.length > 0){
                        ...
                        for(var i=0;i<imgelements.length;i++){
                            ...
                            if(tmpid.includes("reportid-")){
                                ...
                                var newUrl = rootUrl[0]+"analyzesingleimage.php?courseid="+cCourseId+"&quizid="+cQuizId+"&cmid="+cCmId+"&studentid="+cStudentId+"&reportid="+cReportId+"&imgid="+imgrowid+"&sesskey="+encodeURIComponent(sesskey);
