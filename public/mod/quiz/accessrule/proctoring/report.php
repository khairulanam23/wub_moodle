...
if (!empty($logaction) && $logaction === 'delete') {
    require_sesskey();
...
if (
    ...
    if ($studentid != null && $cmid != null && $courseid != null && $reportid != null) {
        ...
        $sqlexecuted = $logrepo->get_student_quiz_logs((int)$courseid, (int)$cmid, (int)$studentid);
        ...
        $analyzeactionurl = (new moodle_url('/mod/quiz/accessrule/proctoring/analyzeimage.php'))->out(false);
        ...
        $templatecontext = (object)[
            ...
            'analyzeactionurl' => $analyzeactionurl,
            'sesskey' => sesskey(),
            'studentid' => $studentid,
            'cmid' => $cmid,
            'courseid' => $courseid,
