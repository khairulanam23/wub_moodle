...
$PAGE->navbar->add(get_string("records_navbar","local_mass_enroll"),"/local/mass_enroll/records.php");
$PAGE->set_heading('');
...
print_r($OUTPUT->render_from_template('local_mass_enroll/records',$context_data));
